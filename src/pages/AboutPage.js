    ...
    return (
        <motion.div exit={{opacity:0}} initial={{opacity:0}} animate={{opacity:1}}  className="flex justify-center">
            <div className="flex flex-col items-center">
                ...
                <p className="text-md md:text-xl mx-10 md:mx-40 mt-12 text-center">I'm a full-stack developer with over 10 years of experience writing code. I work with top level agencies around the world creating interactive and responsive web applications.</p>
                <p className="text-md md:text-xl mx-10 md:mx-40 mt-8 text-center">I am always staying on the cutting edge of web technologies and I am always trying to push the envelope of what can be designed without sacraficing website performance and stability.</p>
                <div className="flex justify-center flex-col md:flex-row mt-12 gap-8">
                    {renderedSections}
                </div>
            </div>
        </motion.div>
